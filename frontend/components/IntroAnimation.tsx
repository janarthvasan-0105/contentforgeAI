...
/**
 * Stripe-inspired entrance animation for ContentForge AI.
 * Particle constellation with arc-draw and serif wordmark reveal.
 */
export default function IntroAnimation({ onDone }: Props) {
  ...
  return (
    <div
      ...
      style={exit ? { opacity: 0, transition: "opacity 600ms ease" } : undefined}
    >
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 36 }}>
        ...
        <div style={{ textAlign: "center" }}>
          <div
            ...
            style={{ fontSize: 44, lineHeight: 1, color: "#1C1917", animationDelay: "1600ms" }}
          >
            Content<span style={{ color: "#B8482B", fontStyle: "italic" }}>Forge</span>
          </div>
          <div
            className="eyebrow animate-word-reveal"
            style={{ marginTop: 14, animationDelay: "1900ms" }}
          >
