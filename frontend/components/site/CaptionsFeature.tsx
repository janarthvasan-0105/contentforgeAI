...
export default function CaptionsFeature() {
  return (
      ...
      <div className="max-w-7xl w-full flex flex-col md:flex-row items-center gap-16">
        ...
        <div className="flex-1 flex flex-col items-start text-left">
          ...
          <h2 className="text-4xl sm:text-5xl font-black text-black tracking-tight leading-tight mb-6">
            One campaign. <br/> Every voice.
          </h2>
          
          <p className="text-lg text-neutral-500 max-w-lg leading-relaxed mb-8">
            Stop writing the same caption ten different ways. Your Copywriter agent automatically generates funny, educational, professional, and storytelling variants for every platform—instantly. Review, compare, and copy with a single click.
          </p>
          
          <Link
            href="/multi-tone-captions"
            className="inline-flex items-center gap-2 text-[15px] font-bold text-[#8763e5] hover:text-[#704ec2] transition group"
          >
            Explore the Multi-Tone Captions feature
        ...
        <div className="flex-[1.5] w-full relative">
          ...
          >
            <Image
              ...
              alt="Multi-Tone Captions Interface"
              width={1000}
              height={700}
