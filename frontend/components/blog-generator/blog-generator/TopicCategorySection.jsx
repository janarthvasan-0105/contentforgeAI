    ...
    return (
        <Card className="bg-white rounded-xl shadow-sm border border-black/5">
            <CardHeader className="flex flex-row items-center space-x-3 pb-3">
                <div className="p-2 bg-neutral-50 text-[#8763e5] rounded-lg">
                    <FolderOpen className="w-5 h-5" />
                </div>
                <div>
                    <CardTitle className="text-lg font-bold text-neutral-900">1. Topic & Category</CardTitle>
                    <p className="text-xs text-neutral-500">Specify your main blog topic and target category.</p>
                </div>
            </CardHeader>
            <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                        <Label htmlFor="topic" className="text-sm font-semibold text-neutral-700 flex items-center gap-1 text-neutral-900">
                            Topic <span className="text-neutral-500 text-xs font-normal">(leave empty for auto-bulk)</span>
                        </Label>
                        <Input
                            id="topic"
                            name="topic"
                    ...
                    <div className="space-y-2">
                        <div className="flex justify-between items-center">
                            <Label htmlFor="category" className="text-sm font-semibold text-neutral-700 flex items-center gap-1 text-neutral-900">Category</Label>
                            <button
                                type="button"
                                onClick={() => setIsAddCategoryOpen(true)}
                                className="text-xs font-semibold text-[#8763e5] hover:text-[#8763e5] transition-colors flex items-center gap-1"
                            >
                ...
                {isBulkMode && (
                    <div className="bg-neutral-50 border border-neutral-200 rounded-lg p-3 text-sm text-[#8763e5] animate-in fade-in duration-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                        <Label htmlFor="numBlogs" className="text-sm font-semibold text-neutral-700 flex items-center gap-1 text-neutral-900">Number of Blogs</Label>
                        <Input
                            id="numBlogs"
                            name="numBlogs"
                            type="number"
