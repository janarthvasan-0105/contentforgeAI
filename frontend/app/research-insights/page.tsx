...
import { ArrowLeft, Lightbulb, Search, Crosshair, RefreshCcw } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-white text-black font-sans selection:bg-[#8763e5] selection:text-white">
      ...
      <section className="pt-24 pb-16 px-6 max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        >
          Before a single word is written, your Researcher agent scrapes the web, analyzes competitors, and extracts high-converting angles tailored to your exact industry. 
        </motion.p>
      </section>
      ...
      <section className="bg-[#f9f9fb] border-y border-black/5 py-24 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
          <div className="flex flex-col items-center md:items-start">
            ...
            <h3 className="text-xl font-bold mb-3 text-black">Competitive Analysis</h3>
            <p className="text-neutral-500 leading-relaxed">
              The AI automatically reads what your competitors are posting and extracts the core narratives driving engagement in your niche.
            </p>
          </div>
          
          <div className="flex flex-col items-center md:items-start">
            <div className="h-12 w-12 rounded-full bg-white border border-black/10 shadow-sm flex items-center justify-center mb-6">
              <Crosshair size={24} className="text-[#8763e5]" />
            </div>
            <h3 className="text-xl font-bold mb-3 text-black">Pain-Point Targeting</h3>
            <p className="text-neutral-500 leading-relaxed">
              Discover exactly what your audience is struggling with. The agent frames these pain points into actionable hooks for your content.
            </p>
          </div>

          <div className="flex flex-col items-center md:items-start">
            <div className="h-12 w-12 rounded-full bg-white border border-black/10 shadow-sm flex items-center justify-center mb-6">
              <RefreshCcw size={24} className="text-[#8763e5]" />
            </div>
            <h3 className="text-xl font-bold mb-3 text-black">Dynamic Regeneration</h3>
            <p className="text-neutral-500 leading-relaxed">
              Not happy with the angle? Hit regenerate on any specific insight to instantly task the researcher with exploring a different narrative path.
            </p>
          </div>
        </div>
      </section>
